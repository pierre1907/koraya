...
export default function UsersAdminPage() {
  ...
  return (
    <div>
      <AdminPageHeader title="Utilisateurs" actionLabel="Nouvel utilisateur" onAction={openCreate} />
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-gray-100 bg-white">
        {loading ? (
          ...
          <p className="px-6 py-8 text-center text-sm text-gray-500">Aucun utilisateur pour le moment.</p>
        ) : (
